...
var ContactService = function () {
    ...
    var ContactService = _classThis = /** @class */ (function () {
        function ContactService_1(http) {
            this.http = http;
            this.apiUrl = 'https://booklibaryapi.azurewebsites.net/api/Contact/send-email'; // .NET API endpoint
        }
        ContactService_1.prototype.sendContactForm = function (formData) {
